...
public class ActivityAnadirDireccion
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AppDiaryHobbies.Activities.ActivityAnadirDireccion, AppDiaryHobbies, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ActivityAnadirDireccion.class, __md_methods);
	}


	public ActivityAnadirDireccion ()
	{
		super ();
		if (getClass () == ActivityAnadirDireccion.class)
			mono.android.TypeManager.Activate ("AppDiaryHobbies.Activities.ActivityAnadirDireccion, AppDiaryHobbies, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
