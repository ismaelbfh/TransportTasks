...
public class ActivityAnadirCliente
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AppDiaryHobbies.ActivityAnadirCliente, AppDiaryHobbies, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ActivityAnadirCliente.class, __md_methods);
	}


	public ActivityAnadirCliente ()
	{
		super ();
		if (getClass () == ActivityAnadirCliente.class)
			mono.android.TypeManager.Activate ("AppDiaryHobbies.ActivityAnadirCliente, AppDiaryHobbies, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
