...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("AppDiaryHobbies.ActivityAnadirCliente, AppDiaryHobbies", ActivityAnadirCliente.class, __md_methods);
	}
	...
	public ActivityAnadirCliente ()
	{
		...
		if (getClass () == ActivityAnadirCliente.class)
			mono.android.TypeManager.Activate ("AppDiaryHobbies.ActivityAnadirCliente, AppDiaryHobbies", "", this, new java.lang.Object[] {  });
	}
